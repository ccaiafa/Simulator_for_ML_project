...
disp('SAVING RESULTS...')
save(fullfile(dataOutputPath,sprintf('fe_struct_with_predicted_signal_from_Arcuate_%s_%s_%s_%s.mat',subject,num2str(alg),num2str(lparam),num2str(conn))), 'fe','-v7.3')
